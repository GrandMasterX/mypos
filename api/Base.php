...
/**
 * mypos-API-PHP : Simple PHP wrapper
 *
 * PHP version > 5.3.10
 *
 * @category Awesomeness
 * @package  mypos-API-PHP
 * @author   GrandMasterX <zgrandmasterz@gmail.com>
 * @license  MIT License
 * @version  1.0.0
 * @link     http://github.com/GrandMasterX/mypos
 */
class Base
{
     ...
     */
    protected function _addPostParam($paramName, $paramValue) {
    ...
    protected function _processPost() {
        ...
        if (!$fp) {
            throw new IPC_Exception('Error connectiong IPC URL');
        } else {
            $eol = "\r\n";
